...
?>
  ...
  <header>
    ...
    <a href="../aluno/aluno_prof.php?turma_id=<?php echo $turma_id; ?>" class="btn-aluno">Alunos</a>
    <a href="../horario/horario_prof.php?turma_id=<?php echo $turma_id; ?>" class="btn-horario">Horários</a>
    <a href="../home/tela_inicial_prof.php" class="btn-voltar">Voltar</a>
  </header>
